...
const numeriLotto = [5, 7, 21, 67, 53, 87];
...
//Scrivere
const nuovoNumero1 = 9;
//è come scrivere
const nuovoNumero2 = 7;
//Il tipo di nuovoNumero è number e non Numero
let nuovoOggettoGeometrico;
...
const bear = { name: "Yogi", honey: true };
const smallBear = { name: "Teddy", honey: true };
